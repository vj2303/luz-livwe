...
import { ChevronDown, Copy, Heart, Share2, Phone, ChevronRight, CircleArrowRight } from 'lucide-react';
      ...
      <div className="px-4 mt-4">
        ...
        <div className="flex mt-2 sm:text-[16px] text-[12px] space-x-4">
          <button className="flex items-center space-x-2 px-1 sm:px-2 sm:py-3 py-2 bg-gray-200 rounded-lg">
            <Link target='_blank' href={mapLink}>  <span className='flex gap-1 text-gray-500 items-center'> <CircleArrowRight size={20} /> Get Directions  <ChevronRight size={20} /></span>
            </Link>
          </button>
